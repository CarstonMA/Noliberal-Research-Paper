...
```{r appendix, ref.label = c("setup","data", "variable names","examine data", "tibble",  "helper",  "regression", "DiD", "plot helpers",  "Pannel Generation", "Single Plot"), echo = TRUE, eval = FALSE}